...
namespace Evalaute {
    ...
    inline int getPassedPawnBonus(int pieceType, int square, uint64_t opponent, uint64_t friendly){
    ...
    inline int evaluateKingSafety(int pieceType, int sq, bool isWhite, uint64_t king, uint64_t pawns) {
    ...
    inline int getPSTBonus(int pieceType, int sq, bool isWhite) {
    ...
    inline int evaluateMobility(int pieceType, int sq, bool isWhite, uint64_t ownPieces, uint64_t enemyPieces) {
        uint64_t moves = 0;
        switch (pieceType) {
