...
namespace MoveGen {
    ...
    inline uint64_t getPseudo(int square, int pieceType, bool isWhite, const uint64_t occupancy){
        switch (pieceType){
    ...
    inline void getPseudoAttacks(int from, int movingPiece, int pieceType, bool isWhite, const uint64_t occupancy, const uint64_t friendly, State& state, std::vector<Move>& pseudoMoves) {
